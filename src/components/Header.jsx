      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            >
              <img src={logoUrl} alt={t('common.busTicketLogo')} className="h-8 w-auto" />
              <span className="hidden sm:block">BusTicket</span>
            </Link>
          </motion.div>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="relative">
              ...
              <select
                className="pl-10 pr-8 py-2 text-sm border border-gray-200 rounded-lg bg-white focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none cursor-pointer"
                value={i18n.language}
            ...
            {user ? (
              <div className="flex items-center space-x-3">
                <motion.div
                  className="flex items-center space-x-2 px-4 py-2 bg-primary-50 rounded-lg"
                  whileHover={{ scale: 1.05 }}
                >
                ...
                <div className="space-y-3 pt-4 border-t border-gray-200">
                    ...
                    >
                      {theme === 'light' ? (
                        <>
                          ...
                          <span className="text-sm text-gray-600">{t('common.darkMode')}</span>
                        </>
                      ) : (
                        <>
                          <Sun className="w-4 h-4 text-gray-600" />
                          <span className="text-sm text-gray-600">{t('common.lightMode')}</span>
                        </>
                      )}
                    </button>
                  </div>
                  ...
                  {user ? (
                    <div className="space-y-2">
                      ...
                      <button
                        onClick={handleLogout}
                        className="w-full flex items-center justify-center space-x-2 px-4 py-2 text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200"
                      >
                        <LogOut className="w-4 h-4" />
                        <span>{t('common.logout')}</span>
                      </button>
                    ...
                    <div className="space-y-2">
                      <Link
                        to="/login"
                        className="block w-full text-center px-4 py-2 text-sm font-medium text-primary-600 hover:bg-primary-50 rounded-lg transition-colors duration-200"
                        onClick={() => setIsMenuOpen(false)}
                      >
                        {t('common.login')}
                      </Link>
